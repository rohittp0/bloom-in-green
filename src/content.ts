export const circleData = {
    "Education": {img: "/img/placeholder-icon.png", text: "Education is abc"},
    "Music": {img: "/img/placeholder-icon.png", text: "Education is abc"},
    "Sustainablity": {img: "/img/placeholder-icon.png", text: "Education is abc"},
